...
def main():
 class Slide:      
    def __init__(self,root):
        ...
        frame1.place(x=330,y=10,width=900,height=850)
        self.frame1img=ImageTk.PhotoImage(file="images/slide book/story1_1pic.png")
        frame1img=Label(frame1,image=self.frame1img).place(x=5,y=5,width=900,height=780)

        #frame2
        frame2=Frame(self.root,bg='white')
        frame2.place(x=330,y=10,width=900,height=850)
        self.frame2img=ImageTk.PhotoImage(file="images/slide book/story1_2pic.png")
        frame2img=Label(frame2,image=self.frame2img).place(x=5,y=5,width=900,height=780)

        #frame3
        frame3=Frame(self.root,bg='white')
        frame3.place(x=330,y=10,width=900,height=850)
        self.frame3img=ImageTk.PhotoImage(file="images/slide book/story1_3pic.png")
        frame3img=Label(frame3,image=self.frame3img).place(x=5,y=5,width=900,height=780)

        next1bt=Button(frame1,text='NEXT',cursor='hand2',padx=0,pady=0,bg='black',fg='white',font=("adobe gothic std b",18,"bold"),command=lambda:showframe(frame2)).place(x=700,y=770)
        
        previous2bt=Button(frame2,text='PREVIOUS',cursor='hand2',padx=0,pady=0,bg='black',fg='white',font=("adobe gothic std b",18,"bold"),command=lambda:showframe(frame1)).place(x=50,y=770)      
        next2bt=Button(frame2,text='NEXT',cursor='hand2',padx=0,pady=0,bg='black',fg='white',font=("adobe gothic std b",18,"bold"),command=lambda:showframe(frame3)).place(x=700,y=770)

        previous3bt=Button(frame3,text='PREVIOUS',cursor='hand2',padx=0,pady=0,bg='black',fg='white',font=("adobe gothic std b",18,"bold"),command=lambda:showframe(frame2)).place(x=50,y=770)
        next3bt=Button(frame3,text='NEXT',cursor='hand2',padx=0,pady=0,bg='black',fg='white',font=("adobe gothic std b",18,"bold"),command=lambda:showframe(frame1)).place(x=700,y=770)
    ...
    def playsong(self):
      ...
      try:
         ...
         mixer.init()
         mixer.music.load('audio/Slide story1 audio.mp3')
