...
def main():
 class ebook:
   def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="images/ebook_home/ebook3 bg.jpg")
        ...
        pdfFileObj = open('ebooks/Youth.pdf', 'rb') 
   ...
   def playsong(self):
      ...
      try:
         ...
         if(reader== 'Female'):
               mixer.init()
               mixer.music.load('audio/Youth f.mp3')
               mixer.music.set_volume(current_volume)
               mixer.music.play()
         elif(reader == 'Male'):
               mixer.init()
               mixer.music.load('audio/Youth m.mp3')
               mixer.music.set_volume(current_volume)
               mixer.music.play()
      except:
