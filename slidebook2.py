...
def main():
 class Slide:      
    def __init__(self,root):
        ...
        self.frame1img=ImageTk.PhotoImage(file="images/slide book/story2_1pic.png")
        ...
        self.frame2img=ImageTk.PhotoImage(file="images/slide book/story2_2pic.png")
        ...
        self.frame3img=ImageTk.PhotoImage(file="images/slide book/story2_3pic.png")
    ...
    def playsong(self):
      ...
      try:
         ...
         mixer.init()
         mixer.music.load('audio/Slide story2 audio.mp3')
