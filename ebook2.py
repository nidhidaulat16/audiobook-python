...
def main():
 class ebook:
   def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="images/ebook_home/ebook2 bg.jpg")
        bg=Label(self.root,image=self.bg).place(x=0,y=0,relwidth=1,relheight=1)
        
       
        
        frame1=Frame(self.root,bg='white',highlightbackground='black',highlightthickness='3')
        frame1.place(x=460,y=790,width=680,height=80)
        
        pdfFileObj = open('ebooks/The_Story_of_An_Hour.pdf', 'rb') 
        ...
        playbtn=Button(frame1,image=self.playbt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.playsong).place(x=5,y=5)
        
        self.pausebt=ImageTk.PhotoImage(file="images/icons/pause bt.png")
        pausebtn=Button(frame1,image=self.pausebt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.pausesong).place(x=105,y=5)
        
        self.resumebt=ImageTk.PhotoImage(file="images/icons/resume bt.png")
        resumebtn=Button(frame1,image=self.resumebt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.resumesong).place(x=205,y=5)
        
        self.stopbt=ImageTk.PhotoImage(file="images/icons/stop bt.png")
        stopbtn=Button(frame1,image=self.stopbt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.stopsong).place(x=305,y=5)
        
        self.homebt=ImageTk.PhotoImage(file="images/icons/home bt.png")
        homebtn=Button(frame1,image=self.homebt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.home).place(x=505,y=5)
        
        self.backbt=ImageTk.PhotoImage(file="images/icons/back bt.png")
        backbtn=Button(frame1,image=self.backbt,cursor="hand2",bg="black",fg="black",font=("britanic bold",15,"bold"),command=self.back).place(x=605,y=5)
   ...
   def playsong(self):
      ...
      try:
         ...
         if(reader== 'Female'):
               mixer.init()
               mixer.music.load('audio/The_Story_of_An_Hour f.mp3')
               mixer.music.set_volume(current_volume)
               mixer.music.play()
         elif(reader == 'Male'):
               mixer.init()
               mixer.music.load('audio/The_Story_of_An_Hour m.mp3')
               mixer.music.set_volume(current_volume)
               mixer.music.play()
      except:
